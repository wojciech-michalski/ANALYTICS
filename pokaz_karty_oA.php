...
$karty_zatwierdzone=mysqli_query($kon,"SELECT * FROM `karty_obciazen_w` WHERE `wydzial`=1 GROUP BY `wykladowca_nazwisko`,`rok_akademicki`,`semestr_ZL`");
       ...
       include('view/sidenav.php');
        ...
        <div class="card-body d-sm-flex justify-content-between">
          ...
          <h4 class="mb-2 mb-sm-0 pt-1">
            ...
            <span>Karty zatwierdzone</span> <span>/</span> <span>Wydział Architektury</span>
          </h4>
     ...
     <div class="card">
       <table id="dtMaterialDesignExample" class="table table-striped table-condensed" cellspacing="0" width="90%" >
           ...
           <tr><td><?php echo $kn;?></td>
               ...
               <td><form method="POST" action="main.php?mode=koA"><input type="hidden" name="rok_akademicki" 
                   ...
                   <input type="hidden" name="semestr_ZL" 
                    ...
                    <button type="submit" class="btn btn-indigo" style="width:10rem;">Pokaż kartę</button></form>
                 <?php  
                 
                 $pesel=sqlsrv_fetch_array(sqlsrv_query($conn,"SELECT OS_PESEL FROM OSOBA WHERE "
                         . "OS_IMIE_I='$karta[wykladowca_imie]' AND OS_NAZWISKO='$karta[wykladowca_nazwisko]' "
