       ...
       include('view/sidenav.php');
        ...
        <div class="card-body d-sm-flex justify-content-between">
          ...
          <h4 class="mb-2 mb-sm-0 pt-1">
            ...
            <span>/</span>
            <span>Karty obciążeń / Rachunki / Wydział Architektury / <?php echo $_POST['wykladowca_imie']." ".$_POST['wykladowca_nazwisko'];?></span>
          </h4>
...
?>
        ...
        <form class="text-center" style="color: #757575;" action="controller/gen_rachunek.php" method="POST">
            ...
            <input type="hidden" name="semestr_ZL" value="<?php echo $_POST['semestr_ZL'];?>"/>
             ...
             <input type="hidden" name="wykladowca_nazwisko" value="<?php echo $_POST['wykladowca_nazwisko'];?>"/><input type="hidden" name="wydzial" value="1"/>
...
?>
        ...
        <form class="text-center" style="color: #757575;" action="controller/gen_rachunek.php" method="POST">
            ...
            <input type="hidden" name="semestr_ZL" value="<?php echo $_POST['semestr_ZL'];?>"/>
             <input type="hidden" name="wykladowca_imie" value="<?php echo $_POST['wykladowca_imie'];?>"/>
             <input type="hidden" name="wykladowca_nazwisko" value="<?php echo $_POST['wykladowca_nazwisko'];?>"/>
...
<div class="card-header text-center" >
        ...
        <div class="card-body d-sm-flex justify-content-between">
            ...
            //echo $pesel[0];
            $rachq=mysqli_query($kon,"SELECT * FROM `rachunki` WHERE `pesel`='$pesel[0]' AND `wydzial`=1");
