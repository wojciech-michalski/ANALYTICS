...
switch($_POST['tabela']) {
case "ocena_administracji":
    $values_query="SELECT $tabela.id,$tabela.id_prowadzacy,
$tabela.PYT_1,$tabela.PYT_2,$tabela.PYT_3,$tabela.PYT_4,
$tabela.PYT_5,$tabela.PYT_6,$tabela.PYT_7,$tabela.PYT_8,
$tabela.PYT_9,$tabela.PYT_10,$tabela.PYT_11,$tabela.PYT_12,
$tabela.PYT_13,$tabela.PYT_14,$tabela.PYT_15,
$tabela.PYT_16,$tabela.PYT_17,$tabela.PYT_18,$tabela.PYT_19,
$tabela.PYT_20,$tabela.PYT_21,$tabela.PYT_22,$tabela.PYT_23,
$tabela.PYT_24,$tabela.PYT_25,$tabela.PYT_26,$tabela.PYT_27,"
        . "$tabela.PYT_28,$tabela.PYT_29,$tabela.PYT_30 "
        . "FROM `$tabela` INNER JOIN `prowadzacy` ON prowadzacy.id=$tabela.id_prowadzacy "
        . "WHERE `$element`=$values_query_element AND prowadzacy.rok_akademicki LIKE '%$_POST[rok_akademicki]'";
$values_query_negative="
SELECT $tabela.id,$tabela.id_prowadzacy,
$tabela.PYT_1,$tabela.PYT_2,$tabela.PYT_3,$tabela.PYT_4,
$tabela.PYT_5,$tabela.PYT_6,$tabela.PYT_7,$tabela.PYT_8,
$tabela.PYT_9,$tabela.PYT_10,$tabela.PYT_11,$tabela.PYT_12,
$tabela.PYT_13,$tabela.PYT_14,$tabela.PYT_15,
...
$tabela.PYT_20,$tabela.PYT_21,$tabela.PYT_22,$tabela.PYT_23,
$tabela.PYT_24,$tabela.PYT_25,$tabela.PYT_26,$tabela.PYT_27,"
        . "$tabela.PYT_28,$tabela.PYT_29,$tabela.PYT_30 FROM `$tabela` "
        . "INNER JOIN `prowadzacy` ON prowadzacy.id=$tabela.id_prowadzacy "
        . "WHERE `$element`<>$values_query_element AND prowadzacy.rok_akademicki LIKE '%$_POST[rok_akademicki]'";
break;
...
$tabela.PYT_20,$tabela.PYT_21,$tabela.PYT_22,$tabela.PYT_23,
$tabela.PYT_24,$tabela.PYT_25,$tabela.PYT_26,$tabela.PYT_27,"
        . "$tabela.PYT_28,$tabela.PYT_29,$tabela.PYT_30,$tabela.PYT_31 "
        . "FROM `$tabela` INNER JOIN `prowadzacy` ON prowadzacy.id=$tabela.id_prowadzacy "
        . "WHERE `$element`=$values_query_element AND prowadzacy.rok_akademicki LIKE '%$_POST[rok_akademicki]'";
$values_query_negative="
SELECT $tabela.id,$tabela.id_prowadzacy,
...
$tabela.PYT_20,$tabela.PYT_21,$tabela.PYT_22,$tabela.PYT_23,
$tabela.PYT_24,$tabela.PYT_25,$tabela.PYT_26,$tabela.PYT_27,"
        . "$tabela.PYT_28,$tabela.PYT_29,$tabela.PYT_30,$tabela.PYT_31 FROM `$tabela` "
        . "INNER JOIN `prowadzacy` ON prowadzacy.id=$tabela.id_prowadzacy "
        . "WHERE `$element`<>$values_query_element AND prowadzacy.rok_akademicki LIKE '%$_POST[rok_akademicki]'";
break;
}
...
case "ocena_administracji":
    $values_query="SELECT $tabela.id,$tabela.id_prowadzacy,
$tabela.id,$tabela.id_prowadzacy,
$tabela.PYT_1,$tabela.PYT_2,$tabela.PYT_3,$tabela.PYT_4,
$tabela.PYT_5,$tabela.PYT_6,$tabela.PYT_7,$tabela.PYT_8,
$tabela.PYT_9,$tabela.PYT_10,$tabela.PYT_11,$tabela.PYT_12,
$tabela.PYT_13,$tabela.PYT_14,$tabela.PYT_15,
...
$tabela.PYT_24,$tabela.PYT_25,$tabela.PYT_26,$tabela.PYT_27,"
        . "$tabela.PYT_28,$tabela.PYT_29,$tabela.PYT_30"
            . " FROM `$tabela`INNER JOIN `prowadzacy` ON prowadzacy.id=$tabela.id_prowadzacy "
            . "WHERE `$element` LIKE $values_query_element AND prowadzacy.rok_akademicki "
...
$tabela.PYT_24,$tabela.PYT_25,$tabela.PYT_26,$tabela.PYT_27,"
        . "$tabela.PYT_28,$tabela.PYT_29,$tabela.PYT_30"
            . " FROM `$tabela` "
            . "INNER JOIN `prowadzacy` ON prowadzacy.id=$tabela.id_prowadzacy "
            . "WHERE `$element` NOT LIKE $values_query_element AND prowadzacy.rok_akademicki "
            . "LIKE '%$_POST[rok_akademicki]'";
    break;
case "ocena_administracji2":
      $values_query="SELECT $tabela.id,$tabela.id_prowadzacy,
