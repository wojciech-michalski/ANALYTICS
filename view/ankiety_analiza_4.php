<?php
   ...
   // echo "SELECT * FROM `$_POST[analiza]` WHERE $warunek";
       $query=mysqli_query($kon,"SELECT * FROM `$_POST[analiza]` WHERE `kierunek`='$_POST[kierunek]'");
...
$k=0;
     ...
     <div class="card">
        ...
        <div class="card-header text-center"><?php echo $_POST['analiza']; echo "<br/>".$_POST['kierunek'];?>
            <br/><?php
    ...
    foreach ($csvhead as $header){
        ...
        foreach($labels as $label){
            ...
            $value[$label]=mysqli_num_rows(mysqli_query($kon,"SELECT * FROM `$_POST[analiza]`"
                    . " WHERE `$header`=$label AND `kierunek`='$_POST[kierunek]'"));
