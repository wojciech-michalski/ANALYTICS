<div class="modal fade" id="odsiewModal" tabindex="-1" role="dialog" aria-labelledby="odsiewModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content"><form method="POST" action="main.php?mode=deanreport1">
 ...
 <div class="md-form">
    ...
    <label for="date-picker-example2">Data stop</label>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary">Pokaż odsiew</button>
            </div></form>
        </div>
    </div>
    </div>
